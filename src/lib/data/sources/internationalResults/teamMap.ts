...
export const CANONICAL_NATIONS: ReadonlyArray<CanonicalNation> = [
  ...
  n('czech-republic', 'Czech Republic', 'CZE', 'UEFA', ['Czech Republic', 'Czechia']),
  ...
  n('south-korea', 'South Korea', 'KOR', 'AFC', ['South Korea', 'Korea Republic']),
  ...
  n('ivory-coast', 'Ivory Coast', 'CIV', 'CAF', ['Ivory Coast', "Cote d'Ivoire"]),
  ...
  n('curacao', 'Curaçao', 'CUW', 'CONCACAF', ['Curaçao', 'Curacao']),
