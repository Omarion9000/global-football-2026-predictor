...
A full-stack football analytics platform that estimates the probability of every outcome for every FIFA World Cup 2026 match — built as a portfolio project that values clarity, statistical honesty, and architectural discipline.

> **Independent analytical project.** Not affiliated with FIFA, any confederation, any national federation, or any commercial collectibles publisher.

## What it does

- Lists every World Cup 2026 match grouped by day, with team, venue, kickoff, live countdown, and status.
...
- It does not reproduce FIFA, confederation, federation, Panini, or EA Sports artwork or marks.

See [`docs/04_DATA_AND_LEGAL_POLICY.md`](docs/04_DATA_AND_LEGAL_POLICY.md) for the full policy.
