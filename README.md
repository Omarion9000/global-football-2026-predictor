...
| 9C        | ✅ Tournament simulator — Monte Carlo over the 2026 group + 32-team knockout draw, deterministic seeded RNG, manually-edited `results.json` for the live-update workflow. Pure offline engine; no UI, no live API. |
